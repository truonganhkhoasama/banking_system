...
import { depositSchema } from '../../schemas/accountSchemas.js';

router.post('/customers', authenticateToken, authorizeRoles('employee'), createUser);
router.post('/deposit', authenticateToken, authorizeRoles('employee'), validateSchema(depositSchema), depositToAccount);
