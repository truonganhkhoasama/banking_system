...
export default function initModels(sequelize) {
  ...
  InterbankTransactions.belongsTo(LinkedBanks, { as: "bank_code_linked_bank", foreignKey: "bank_code", targetKey: "bank_code" });
  LinkedBanks.hasMany(InterbankTransactions, { as: "interbank_transactions", foreignKey: "bank_code", targetKey: "bank_code" });
